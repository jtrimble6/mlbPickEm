...
import PLActionNav from '../../components/nav/PLActionNav'
import PLBar from '../../components/profile/premierLeagueBar'
import PLCalendar from '../../components/calendar/PremierLeagueCalendar'
import PLLeaderboard from '../../components/leaderboards/PremierLeagueLeaderboard'
//import Games from '../../components/games/Games'
// import moment from 'moment';
import $ from 'jquery'
import '../../css/actionPage.css'

class PLActionPage extends Component {
  constructor(props) {
    super(props)
    this.state = {
      thisWeek: '',
