              ...
              <Jumbotron>
                <Container fluid>
                  <div className="display-4">
                    ...
                    <h4 className='winsTitle'>Final Golfer</h4> 
                      {
                        this.props.todaysPicks !== ' & ' && this.props.todaysPick2 !== undefined ? this.props.todaysPicks : this.props.todaysPick1 ? this.props.todaysPick1 : 'No Selection'
                      } <br />
                    <div className="row">
