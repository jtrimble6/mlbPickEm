...
class PLActionNav extends Component {
    constructor(props) {
        super(props);
            ...
            <nav className="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
                <div className="container">
                    ...
                    <span className="navbar-toggler-icon" onClick={this.toggleNavbar}>
                      <Collapse isOpen={!this.state.collapsed} navbar>
                        <Nav navbar className='navItems'>
                            ...
                            <NavItem>
                                <NavLink href="/actionPL">Action</NavLink>
                            </NavItem>
                            <NavItem>
                                <NavLink href="/plLeaderboard">Leaderboard</NavLink>
                            </NavItem>
                            <NavItem>
                                <NavLink href="/plRules">Rules</NavLink>
                            </NavItem>
                            <NavItem>
                    ...
                    <ul className="navbar-nav ml-auto">
                      ...
                      <li className="nav-item">
                        <a className="nav-link js-scroll-trigger" href="/actionPL">Action</a>
                      </li>
                      <li className="nav-item">
                        <a className="nav-link js-scroll-trigger" href="/plLeaderboard">Leaderboard</a>
                      </li>
                      <li className="nav-item">
                        <a className="nav-link js-scroll-trigger" href="/plRules">Rules</a>
                      </li>
                      <li className="nav-item">
