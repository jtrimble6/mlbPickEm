...
class PLLeaderboard extends Component {
    constructor(props) {
        super(props);
        this.state = {
          challengeId: '',
    ...
    changeLogo = () => {
        ...
        let allTeams = JSON.parse(JSON.stringify(plTeams))
                                  ...
                                  <div className="display-4">
                                    ...
                                    <h4 className="winsHeader winsHeaderModal">This Week's Pick</h4>
                                      <div className="userTimer">
                                        ...
                                        {
                                          (this.state.activeUserWeekPick === '') ? <p>The First Game Has Not Started</p> :
                                    ...
                                    <div className="row recordRow">
                                      <div className="col-md-3">
                                        <h4 className='winsHeader winsHeaderModal'>Users Points</h4> {this.state.activeUserPoints}
                                      </div>
                                      <div className="col-md-3">
