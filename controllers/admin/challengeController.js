...
module.exports = {
    ...
    updateUserPick: function(req, res) {
      db.Challenge
        .update(
          { '_id': req.params.id, },
          { $set: { "users.$[username_field].picks.$[gameId_field].result": req.params.result } },
          { arrayFilters: [{"username_field.username": req.params.user}, {"gameId_field.gameId": req.params.gameId}], multi: true } 
          // { 
          //   '_id': req.params.id, 
